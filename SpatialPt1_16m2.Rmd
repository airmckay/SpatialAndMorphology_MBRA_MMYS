...
p1 <- ggplot() + 
  geom_bar(data = M.brandtii, aes(x = BatID), stat = "count", fill = "salmon") +
  theme_bw() + xlab("") + ylab("Obs < 45 m from the bat") + ggtitle("Myotis brandtii (10 bats, 686 obs)")
p2 <- ggplot() + 
  geom_bar(data = M.mystacinus, aes(x = BatID), stat = "count", fill = "lightblue") +
  theme_bw() + xlab("") + ylab("Obs < 45 m from the bat") + ggtitle("Myotis mystacinus (12 bats, 816 obs)")
