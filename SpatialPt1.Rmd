...
### Figure out how to make mcp.all from the data here... 
...
allbats <- list(Astrid.mcp.df, Dagny.mcp.df, Kaja.mcp.df, 
                        ...
                        Ethel.mcp.df, Ida.mcp.df, Louise.mcp.df, Marie.mcp.df, 
                        Ragnhild.mcp.df, Reeda.mcp.df, Stine.mcp.df, Turid.mcp.df)
head(allbats)
...
mcp.all2 <- left_join(mcp.df.all1, sumobs)
head(mcp.all2)
## START HERE
