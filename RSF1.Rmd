...
```{r}
## PCA 
trait.pca <- rda(mat, scale = TRUE) # used and available points together 
...
trait.pca.mbra  <- rda(mat.mbra, scale = TRUE) 
...
trait.pca.mmys  <- rda(mat.mmys, scale = TRUE) 
# used and available points together 
