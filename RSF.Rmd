...
# H20
fit7 = glmer(used ~ Species + H20 + H20*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 
# boundary (singular) fit: see help('isSingular') 

# H30
fit8 = glmer(used ~ Species + H30 + H30*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 
# boundary (singular) fit: see help('isSingular') 

# H40
fit9 = glmer(used ~ Species + H40 + H40*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 
# boundary (singular) fit: see help('isSingular') 

# H50
fit10 = glmer(used ~ Species + H50 + H50*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 

# H60
fit11 = glmer(used ~ Species + H60 + H60*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 

# H70
fit12 = glmer(used ~ Species + H70 + H70*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 

# H80
fit13 = glmer(used ~ Species + H80 + H80*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0) 


fit4 = glmer(used ~ Species + D0 + D0*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit3 = glmer(used ~ Species + D1 + D1*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit4 = glmer(used ~ Species + D2 + D2*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit5 = glmer(used ~ Species + D3 + D3*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit6 = glmer(used ~ Species + D4 + D4*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)

fit7 = glmer(used ~ Species + D5 + D5*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
#boundary (singular) fit: see help('isSingular')

fit8 = glmer(used ~ Species + D6 + D6*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit9 = glmer(used ~ Species + D7 + D7*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit10 = glmer(used ~ Species + D8 + D8*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit11 = glmer(used ~ Species + D9 + D9*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit12 = glmer(used ~ Species + gap3.mean.area + gap3.mean.area*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit13 = glmer(used ~ Species + gap3.sum.area + gap3.sum.area*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit14 = glmer(used ~ Species + gap5.n + gap5.n*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit15 = glmer(used ~ Species + gap5.mean.area + gap5.mean.area*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit16 = glmer(used ~ Species + gap5.sum.area + gap5.sum.area*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular')

fit17 = glmer(used ~ Species + ttops.n + ttops.n*Species + (1|BatID), data=dt1,
              family=binomial(link="logit"),nAGQ = 0)
# boundary (singular) fit: see help('isSingular') 
