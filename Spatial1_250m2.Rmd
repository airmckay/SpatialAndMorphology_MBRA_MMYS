...
# stack.r250<- brick("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/1. Nittedal 2018-2020/Nittedal_Main/Analyses/Spatial and Morphology/Inputs/stdmetrics_z.grd")
# 
# # Warning message:
# # In .rasterFromRasterFile(grdfile, band = band, objecttype, ...) :
# #   size of values file does not match the number of cells (given the data type)
# stack.r250 <- stretch(stack.r250) # This works 
# dim(stack.r250)
# #  180 360   1
